...
class AmazonProductAdvertisingAPI:
    ...
    def __init__(self, associate_id='haruyasu0f-22'):
        """ 初期化処理 """
        # ハッシュ関数とエンコードをset
        self.hash_func = hashlib.sha256
        self.encode_func = base64.b64encode
        #id,keyのset
        self.ACCESS_KEY = 'AKIAI7K5KRMGQS3KMWPQ'
        self.SECRET_KEY = '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'
        self.ASSOCIATE_ID = associate_id

    def get_info(self, asin_code):
...
if __name__ == '__main__':
    amazon= AmazonProductAdvertisingAPI()
    info = amazon.get_info('B07WXL5YPW')
